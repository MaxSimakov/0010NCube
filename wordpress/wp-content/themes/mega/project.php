    ...
    <section class="sSpecificProject section" id="sSpecificProject">
        ...
        <div class="sSpecificProject__slider sSpecificProject__slider--js swiper animate__slideInUp animate__animated wow">
            <div class="swiper-wrapper">
	            ...
	            $size233 = '1400'; // (thumbnail, medium, large, full or custom size)
	            if( $images22 ): ?>
			            <?php foreach( $images22 as $image_id ): ?>
                            <div class="sSpecificProject__slide swiper-slide">
                                <!-- picture-->
                                <picture><?php echo wp_get_attachment_image( $image_id, $size233 ); ?></picture>
                                <!-- /picture-->
                            </div>
			            <?php endforeach; ?>
	            <?php endif; ?>
