...
function eventHandler() {
	...
	$(".dd-head-js").click(function () {
		$(this).next().slideToggle().parent().toggleClass("active").siblings().removeClass("active").find('.sFaq__item-content').slideUp();
	});
	...
	$(".btn-cookie").click(function () {
		writeCookie('cookie-block', 'hide', 30); // document.querySelector(".cookie-block").classList.add("d-none")
	});
